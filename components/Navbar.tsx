...
export const Navbar = () => {
  ...
  const projectCategories = [
    ...
    { name: 'Oficinas', href: '/proyectos?categoria=oficinas', icon: '🏢' },
    { name: 'Cubiertas', href: '/proyectos?categoria=cubiertas', icon: '🏠' },
      ...
      <Container>
        <nav className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {/* Instagram Link */}
            <a
              href="https://www.instagram.com/metalaustralspa/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Instagram Metal Austral"
              className={`p-2 rounded-full transition-all duration-300 hover:scale-110 ${isSolid ? 'text-gray-600 hover:text-pink-500 hover:bg-pink-50' : 'text-white/80 hover:text-white hover:bg-white/10'}`}
            >
